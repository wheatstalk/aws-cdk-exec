...
deeper nested resources. This quality is the means by which we support both
L1 & L2 constructs, but is also a convenient shortcut when your app has only
one executable resource.
